...
// Site configuration for TLEX Documentation
var Site = &s3.Site{
	...
	// URL path prefix (e.g., if hosting at panyam.github.io/tlex/)
	PathPrefix: "/tlex",
...
func main() {
	...
	if *build || os.Getenv("TLEX_DOCS_ENV") != "production" {
		Site.Rebuild(nil)
		Site.Watch()
	}
